  ...
  return (
    <div className="flex flex-col justify-start items-center px-10 bg-30-black-70-white py-20 gap-16">
      <div className="w-full md:px-36 px-0 flex flex-col">
        ...
        <h1 className="text-white-1 head-text">Welcome back!</h1>
      ...
      <div className="flex justify-center items-end flex-col gap-2">
        <div className="bg-black px-2 md:px-10 py-10 border border-[#ffffff5d] glassmorphism rounded-xl flex flex-col gap-5">
          <h1 className="text-white-1 text-heading3-bold">Sign In Now!</h1>
