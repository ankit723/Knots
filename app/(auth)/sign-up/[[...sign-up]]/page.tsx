  ...
  return (
    <div className="flex flex-col justify-start items-center  px-10 bg-30-black-70-white py-20 gap-20">
      <div className="w-full md:px-36 px-0 flex flex-col">
        ...
        <h1 className="text-white-1 head-text">Sign Up Now! To get connected to the world of knots</h1>
      </div>

      <div className="flex flex-col justify-center items-end">
        <div className="bg-black px-3 md:px-10 py-10 border border-[#ffffff5d] glassmorphism rounded-xl flex flex-col gap-5">
          <h1 className="text-white-1 text-heading3-bold">Sign Up Now!</h1>
